...
if __name__ == '__main__':
    ...
    parser.add_argument('--article_url', '-url', help="URL address of article",
                        type=str)
    parser.add_argument('--settings', '-s', help="parser settings file",
                        type=str)
    parser.add_argument('--text_width', '-w', help="parser line width",
                        type=int)
    ...
    TextGenerator.TextGenerator.\
        generate_readability_text(args.article_url, text_width, tags_to_search)
